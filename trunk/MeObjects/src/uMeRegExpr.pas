...
/[ListBegin]/ 为子表达式
  ...
  public
    ...
    function Execute(const aInputString: RegExprString; const aPos: Integer = 1): Boolean;
...
begin
  ...
  try
    ApplyExpression(vRegExpr);
    vRegExpr.InputString := aInputString;
    vPos := aPos;
    Result := iExecute(vRegExpr, vPos);
  finally
    vRegExpr.Free;
  end;
end;
